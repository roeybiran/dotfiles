...
By default, the test cases of a test function run in parallel with each other. For more information about test parallelization, see [](/documentation/testing/parallelization).
...
1. [](/documentation/testing/customtestargumentencodable)
