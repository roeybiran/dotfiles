...
# LICENSE
defaults write license.contexts-license Email -string "$CONTEXTS_LICENSE_EMAIL"
defaults write license.contexts-license Name -string "$CONTEXTS_LICENSE_NAME"
defaults write license.contexts-license Order -string "$CONTEXTS_LICENSE_ORDER"
defaults write license.contexts-license Product -string "$CONTEXTS_LICENSE_PRODUCT"
defaults write license.contexts-license Timestamp -string "$CONTEXTS_LICENSE_TIMESTAMP"
defaults write license.contexts-license Version -string "$CONTEXTS_LICENSE_VERSION"
defaults write license.contexts-license Signature -data "$CONTEXTS_LICENSE_SIGNATURE"

plutil -convert xml1 ~/Library/Preferences/license.contexts-license.plist
dst="$HOME/Library/Application Support/com.contextsformac.Contexts"
mkdir -p "$dst"
mv "$HOME/Library/Preferences/license.contexts-license.plist" "$dst/license.contexts-license"
