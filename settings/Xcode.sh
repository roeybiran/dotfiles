...
test -f /usr/sbin/DevToolsSecurity && sudo /usr/sbin/DevToolsSecurity --enable 1>/dev/null 2>&1
...
# --- hidden settigns ---
# defaults write com.apple.dt.Xcode IDEAdditionalCounterpartSuffixes -array-add Tests Error
